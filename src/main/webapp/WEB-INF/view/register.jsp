		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card">
					...
					<!-- Expressions within ${...} can also include method calls and other Java code -->
					<div class="card-body">
						<form action="createUser" method="post">
							<div class="mb-3">
								<label for="exampleInputFullName1" class="form-label">FullName
								</label> <input type="text" class="form-control" name="fullName"
									id="exampleInputFullName1" aria-describedby="fullName">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="img"
									id="exampleInputImage1" aria-describedby="emailHelp">
							</div>
